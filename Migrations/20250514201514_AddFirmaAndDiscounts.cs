...
{
    /// <inheritdoc />
    public partial class AddFirmaAndDiscounts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirinciIskontoOrani = table.Column<double>(type: "float", nullable: false),
                    IkinciIskontoOrani = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Kullanicilar_Firma_FirmaID",
                        column: x => x.FirmaID,
